        ...
        SELECT
              ...
              FROM (
                ...
                SELECT
                  ...
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Series_Datetime[array_upper(Series_Datetime, 1)] ORDER BY Task_ID) else Series_Datetime[array_upper(Series_Datetime, 1)] end AS Series_Datetime,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Datetime_Started ORDER BY Task_ID) else Datetime_Started end AS Datetime_Started,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Datetime_Finished ORDER BY Task_ID) else Datetime_Finished end AS Datetime_Finished,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Perf_Acquisition_Type[array_upper(Perf_Acquisition_Type, 1)] ORDER BY Task_ID) else Perf_Acquisition_Type[array_upper(Perf_Acquisition_Type, 1)] end  AS Perf_Acquisition_Type,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Perf_Number_Of_Slices[array_upper(Perf_Number_Of_Slices, 1)] ORDER BY Task_ID) else Perf_Number_Of_Slices[array_upper(Perf_Number_Of_Slices, 1)] end  AS Perf_Number_Of_Slices,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Perf_Slice_Thickness[array_upper(Perf_Slice_Thickness, 1)] ORDER BY Task_ID) else  Perf_Slice_Thickness[array_upper( Perf_Slice_Thickness, 1)] end  AS Perf_Slice_Thickness,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Perf_Coverage_z[array_upper(Perf_Coverage_z, 1)] ORDER BY Task_ID) else Perf_Coverage_z[array_upper(Perf_Coverage_z, 1)] end  AS Perf_Coverage_z,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Perf_Scan_Duration[array_upper(Perf_Scan_Duration, 1)] ORDER BY Task_ID) else Perf_Scan_Duration[array_upper(Perf_Scan_Duration, 1)] end  AS Perf_Scan_Duration,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Perf_Series_Type[array_upper(Perf_Series_Type, 1)] ORDER BY Task_ID) else Perf_Series_Type[array_upper(Perf_Series_Type, 1)] end  AS Perf_Series_Type,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Dwi_Number_Of_Slices[array_upper(Dwi_Number_Of_Slices, 1)] ORDER BY Task_ID) else Dwi_Number_Of_Slices[array_upper(Dwi_Number_Of_Slices, 1)] end  AS Dwi_Number_Of_Slices,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Dwi_Slice_Thickness[array_upper(Dwi_Slice_Thickness, 1)] ORDER BY Task_ID) else Dwi_Slice_Thickness[array_upper(Dwi_Slice_Thickness, 1)] end  AS Dwi_Slice_Thickness,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Dwi_Series_Type[array_upper(Dwi_Series_Type, 1)] ORDER BY Task_ID) else Dwi_Series_Type[array_upper(Dwi_Series_Type, 1)] end  AS Dwi_Series_Type,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Ncct_Number_Of_slices ORDER BY Task_ID) else Ncct_Number_Of_slices[array_upper(Ncct_Number_Of_slices, 1)] end  AS Ncct_Number_Of_slices,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Ncct_Slice_Thickness ORDER BY Task_ID) else Ncct_Slice_Thickness[array_upper(Ncct_Slice_Thickness, 1)] end  AS Ncct_Slice_Thickness,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Ncct_Series_Type ORDER BY Task_ID) else Ncct_Series_Type[array_upper(Ncct_Series_Type, 1)] end  AS Ncct_Series_Type,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Cta_Number_Of_Slices ORDER BY Task_ID) else Cta_Number_Of_Slices[array_upper(Cta_Number_Of_Slices, 1)] end  AS Cta_Number_Of_Slices,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Cta_Slice_Thickness ORDER BY Task_ID) else Cta_Slice_Thickness[array_upper(Cta_Slice_Thickness, 1)] end  AS Cta_Slice_Thickness,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Cta_Series_Type ORDER BY Task_ID) else Cta_Series_Type[array_upper(Cta_Series_Type, 1)] end  AS Cta_Series_Type,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Entry_ID[array_upper(Entry_ID, 1)] ORDER BY Task_ID) else Entry_ID[array_upper(Entry_ID, 1)] end  AS Entry_ID,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Task_ID ORDER BY Task_ID) else Task_ID[array_upper(Task_ID, 1)] end  AS Task_ID,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Task_Processing_Type ORDER BY Task_ID) else Task_Processing_Type[array_upper(Task_Processing_Type, 1)] end  AS Task_Processing_Type,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Task_Result ORDER BY Task_ID) else Task_Result[array_upper(Task_Result, 1)] end  AS Task_Result,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Processing_Time_In_Module[array_upper(Processing_Time_In_Module, 1)] ORDER BY Task_ID) else Processing_Time_In_Module[array_upper(Processing_Time_In_Module, 1)] end  AS Processing_Time_In_Module,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Total_Processing_Time_Since_Delivery[array_upper(Total_Processing_Time_Since_Delivery, 1)] ORDER BY Task_ID) else Total_Processing_Time_Since_Delivery[array_upper(Total_Processing_Time_Since_Delivery, 1)] end  AS Total_Processing_Time_Since_Delivery,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Username ORDER BY Task_ID) else Username[array_upper(Username, 1)] end  AS Username,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Number_Of_Slabs ORDER BY Task_ID) else Number_Of_Slabs[array_upper(Number_Of_Slabs, 1)] end  AS Number_Of_Slabs,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Parameter_Name ORDER BY Task_ID) else Parameter_Name[array_upper(Parameter_Name, 1)] end  AS Parameter_Name,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Threshold ORDER BY Task_ID) else Threshold[array_upper(Threshold, 1)] end  AS Threshold,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Volume ORDER BY Task_ID) else Volume[array_upper(Volume, 1)] end  AS Volume,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Cta_Affected_Side ORDER BY Task_ID) else Cta_Affected_Side[array_upper(Cta_Affected_Side, 1)] end  AS Cta_Affected_Side,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Hemi_Ratio ORDER BY Task_ID) else Hemi_Ratio[array_upper(Hemi_Ratio, 1)] end  AS Hemi_Ratio,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Aspects_Affected_Side ORDER BY Task_ID) else Aspects_Affected_Side[array_upper(Aspects_Affected_Side, 1)] end  AS Aspects_Affected_Side,
                  case when ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead (Series_Datetime[array_upper(lead (Series_Datetime), 1)]))) then array_agg(Aspect_Score ORDER BY Task_ID) else Aspect_Score[array_upper(Aspect_Score, 1)] end  AS Aspect_Score
