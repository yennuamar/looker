        ...
        SELECT
              ...
              FROM (
                ...
                SELECT
                  ...
                  array_agg(Series_Datetime[array_upper(Series_Datetime, 1)] ORDER BY Task_ID) FILTER (where ((Series_Datetime[array_upper(Series_Datetime, 1)] = lead(Series_Datetime[0])) or (Series_Datetime[array_upper(Series_Datetime, 1)] = lead(Series_Datetime[array_upper(lead(Series_Datetime), 1)])))) AS Series_Datetime,
