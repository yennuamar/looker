   ...
   # indexes: ["Task_ID"]
    sql: SELECT
          ...
          case when ((table4.Parameter_Name LIKE '%TMAX%') and (table4.Modality = 'MR') and (table4.Module_Name = 'Mismatch')) then 'PWI&DWI'
               ...
               when ((table4.Task_Result is 'Successful') and (table4.Number_Of_Slabs is null) and (table4.Perf_Acquisition_Type = 1) and (table4.Modality = 'MR') and (table4.Module_Name = 'Mismatch')) then 'PWI'
               when ((table4.Task_Result is 'Unsuccessful') and (table4.Number_Of_Slabs is null) and (table4.Perf_Acquisition_Type = 1) and (table4.Modality = 'MR') and (table4.Module_Name = 'Mismatch')) then 'PWI&DWI'
