...
SELECT
  ...
  TIMESTAMP main_table_1.datetime_finished_time[array_upper(main_table_1.datetime_finished_time, 1)] AT TIME ZONE 'PST' AT TIME ZONE '+5' AS "datetime_finished_time",
