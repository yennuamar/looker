view: main_table_2 {
  derived_table: {
    sql: WITH main_table_1 AS (SELECT  rapid_patient_id,
        ...
        manufacturer,
        manufacturer_model,
        array_agg(datetime_started_time order by entry_id DESC) AS datetime_started_time,
        ...
        array_agg(n_slabs order by entry_id DESC) AS n_slabs,
        ...
        array_agg(cta1_affected_side order by entry_id DESC) AS cta1_affected_side,
        array_agg(hem_ratio order by entry_id DESC) AS hem_ratio,
