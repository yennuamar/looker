              ...
              SELECT
                    ...
                    FROM (
                      ...
                      SELECT
                        ...
                        array_agg(Perf_Acquisition_Type[1] ORDER BY Task_ID) AS Perf_Acquisition_Type,
                        array_agg(Perf_Number_Of_Slices[1] ORDER BY Task_ID) AS Perf_Number_Of_Slices,
                        array_agg(Perf_Slice_Thickness[1] ORDER BY Task_ID) AS Perf_Slice_Thickness,
                        array_agg(Perf_Coverage_z[1] ORDER BY Task_ID) AS Perf_Coverage_z,
                        array_agg(Perf_Scan_Duration[1] ORDER BY Task_ID) AS Perf_Scan_Duration,
                        array_agg(Perf_Series_Type[1] ORDER BY Task_ID) AS Perf_Series_Type,
                        array_agg(Dwi_Number_Of_Slices[1] ORDER BY Task_ID) AS Dwi_Number_Of_Slices,
                        array_agg(Dwi_Slice_Thickness[1] ORDER BY Task_ID) AS Dwi_Slice_Thickness,
                        array_agg(Dwi_Series_Type[1] ORDER BY Task_ID) AS Dwi_Series_Type,
                        ...
                        array_agg(Entry_ID[1] ORDER BY Task_ID) AS Entry_ID,
                        ...
                        array_agg(Processing_Time_In_Module[1] ORDER BY Task_ID) AS Processing_Time_In_Module,
                        array_agg(Total_Processing_Time_Since_Delivery[1] ORDER BY Task_ID) AS Total_Processing_Time_Since_Delivery,
